...
(function() {
  var Network, RadialPlacement, activate, root, circleRadius = 3;
    ...
    network.updateSearch = function(searchTerm) {
      ...
      return node.each(function(d) {
        ...
        if (searchTerm.length > 0 && match >= 0) {
          element
            .style("fill", "#ff0000").style("stroke-width", 2.0).style("stroke", "#555").attr("r", circleRadius*4);
          ...
          return element
            ...
            .attr("r", function(){
              if (d.QERMStudent) { return 2*circleRadius;}
